                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="{{ asset('uploads/profile_photo') }}/{{ auth()->user()->profile_photo }}"
                                        class="img-fluid rounded-circle" width="20" alt="">
                                    @else
            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('banner_part.create') }}">Add Banner Info</a></li>
                            <li><a href="{{ route('banner_part.index') }}">Show Banner Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('about.create') }}">Add About Info</a></li>
                            <li><a href="{{ route('about.index') }}">Show About Info</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('solution.create') }}">Add Solution Info</a></li>
                            <li><a href="{{ route('solution.index') }}">Show Solution Info</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Best Work</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('best_works.create') }}">Add Best Work Info</a></li>
                            <li><a href="{{ route('best_works.index') }}">Show Best Work Info</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Fast Area</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('fast_area.create') }}">Add Fast Area Info</a></li>
                            <li><a href="{{ route('fast_area.index') }}">Show Fast Area Info</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('testimonial.create') }}">Add Testimonial Info</a></li>
                            <li><a href="{{ route('testimonial.index') }}">Show Testimonial Info</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('info.create') }}">Add Info</a></li>
                            <li><a href="{{ route('info.index') }}">Show Info</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-layer-1"></i>
                            <span class="nav-text">Msgyou</span>
                        </a>
                        <ul aria-expanded="false">
                            {{-- <li><a href="{{ route('info.create') }}">Add Msgyou</a></li> --}}
                            <li><a href="{{ route('msgindex') }}">Show Msgyou</a></li>
                        </ul>
                    </li>
                </ul>
